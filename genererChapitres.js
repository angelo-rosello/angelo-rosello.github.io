...
const chapitres = [  
    ...
    { numero: 4, nom: "R&eacuteels, fonctions num&eacuteriques", visible: true,  afficherComplet : true, afficherCorrige: true },
    { numero: 5, nom: "Suites r&eacuteelles", visible: true,  afficherComplet : true, afficherCorrige: true },
    { numero: 6, nom: "Polyn&ocircmes", visible: true,  afficherComplet : true, afficherCorrige: true },
    { numero: 7, nom: "Limites de suites", visible: true,  afficherComplet : true, afficherCorrige: true },
    { numero: 8, nom: "D&eacutenombrement", visible: true,  afficherComplet : true, afficherCorrige: true },
    ...
    { numero: 18, nom: "Equivalence et n&eacutegligeabilit&eacute", visible: false, afficherComplet : false,  afficherCorrige: false },
    { numero: 19, nom: "Applications lin&eacuteaires", visible: false, afficherComplet : false,  afficherCorrige: false },
    ...
    { numero: 27, nom: "D&eacuteriv&eacutees successives, formules de Talor", visible: false, afficherComplet : false,  afficherCorrige: false },
    { numero: 28, nom: "Couples de variables al&eacuteatoires", visible: false, afficherComplet : false,  afficherCorrige: false },
    { numero: 29, nom: "Extrema et convexit&eacute", visible: false,  afficherComplet : false, afficherCorrige: false },
    { numero: 30, nom: "Convergences en probabilit&eacutes", visible: false,  afficherComplet : false, afficherCorrige: false },
];
